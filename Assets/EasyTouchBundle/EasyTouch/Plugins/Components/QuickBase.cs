	...
	protected void DoDirectAction(float value){
		...
		case DirectAction.Force:
			if (directRigidBody!=null){
				directRigidBody.AddForce( localAxis * axisValue * force);
			}
			break;
		// Relative force
		case DirectAction.RelativeForce:
			if (directRigidBody!=null){
				directRigidBody.AddRelativeForce( localAxis * axisValue * force);
			}
			break;
		// Torque
		case DirectAction.Torque:
			if (directRigidBody!=null){
				directRigidBody.AddTorque(localAxis * axisValue * force);
			}
		...
		case DirectAction.RelativeTorque:
			if (directRigidBody!=null){
				directRigidBody.AddRelativeTorque(localAxis * axisValue * force);
			}
			break;*/
		}
